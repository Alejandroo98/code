...
import 'package:app_medici/animation/FadeAnimation.dart';
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Column(
                children: <Widget>[
                  FadeAnimation(1.2, makeInput(label: "usuario")),
                  FadeAnimation(1.3, makeInput(label: "contraseña", obscureText: true)),
                  FadeAnimation(1.4, makeInput(label: "Confirma Contraseña", obscureText: true)),
                ],
              ),
